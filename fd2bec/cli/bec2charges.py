...
def prepare_args(description):
    ...
    argv = {"metavar":"\b"}
    parser.add_argument("-i", "--input"    , **argv, type=str  , required=True, help="path to txt file with BEC (e.g. bec.txt)")
    parser.add_argument("-o", "--output"   , **argv, type=str  , required=True, help="path to txt output file (e.g. charges.txt)")
    return parser
