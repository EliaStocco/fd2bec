...
def prepare_args(description):
    ...
    parser.add_argument("-d", "--displacements", **argv, type=str, required=True, help="path to cartesian displacements (e.g. displacement.txt)")
    parser.add_argument("-o", "--output"       , **argv, type=str, required=True, help="path to output displaced structure (e.g. supercell-displaced.extxyz)")
    return parser
