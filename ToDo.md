...
Scripts:
 ...
 - `prepare_linear_system.py`: disable `spglb` to use brute force finite difference
 - generate symmetry inequivalent displacements
 - generate brute force finite difference displacements
